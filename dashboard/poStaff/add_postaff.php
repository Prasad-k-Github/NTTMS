<?php
    ...
    if(isset($_POST["btnSubmit"])){
        ...
        //sql command 
        $sql = "SELECT * FROM po_staff WHERE epf_no ='$epf'";
        $ret = mysqli_query($con,$sql);

        if($row =mysqli_fetch_array($ret)){
            echo " <center style='margin:10px'> <img src='http://localhost/FInal%20Project/dashboard/assets/images/error.png' alt='' width='25px' height='25px'> This epf number already has been added. </center>";
        }
        else{
            //sql command
            $sql2 = "INSERT INTO po_staff VALUES ('$epf','$name','$email','$tele','$password');";

            $ret2 = mysqli_query($con,$sql2);
            
            if($ret2 == 1){
                echo " <center style='margin:10px'> <img src='http://localhost/FInal%20Project/dashboard/assets/images/successfull.png' alt='' width='25px' height='25px'> Po Staff successfully Added.</center>";
            }
        ...
        <div id="main">
            ...
            <section>
                <form action="#" method="post">
                    <div id="input">
                        <input type="text" name="txtEPF" id="" placeholder="Enter EPF No." required>
                        <input type="text" name="txtName" id="" placeholder="Enter Full Name" style="margin-left: 20px;" required><br>
                        <input type="email" name="txtEmail" id="" placeholder="Enter Email" required >
                        <input type="tele" name="txtTele" id="" pattern="[0-9]{10}" placeholder="Enter Tele No." style="margin-left: 20px;" required><br>
                        <input type="text" name="txtPassword" id="" placeholder="Enter Password" required><br>
                    
                    </div>
                    <input type="submit" value="Submit" id="btn" name="btnSubmit">
