<?php
    ...
    if(isset($_POST["btnSubmit"])){
        ...
        //sql command 
        $sql = "SELECT * FROM lecturer WHERE epf_no ='$epf'";
        ...
        if($row =mysqli_fetch_array($ret)){
            ...
            //sql command
            $sql2 = "INSERT INTO lecturer VALUES ('$epf','$name','$email','$tele','$password');";

            $ret2 = mysqli_query($con,$sql2);

            if($ret2 == 1){
                echo " <center style='margin:10px'> <img src='http://localhost/FInal%20Project/dashboard/assets/images/successfull.png' alt='' width='25px' height='25px'> Lecturer successfully Added.</center>";
            }
        }
            ...
            <section>
                ...
                <form action="#" method="post">
                    ...
                    <div id="input">
                        ...
                        <input type="tel" name="txtTele" id="" pattern="[0-9]{10}" placeholder="Enter Tele No." style="margin-left: 20px;" required><br>
