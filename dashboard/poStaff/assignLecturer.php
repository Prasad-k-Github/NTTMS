<?php
    ...
    if(isset($_POST["btnSubmit"])){
        ...
        $lec = $_POST["txtLecturer"];
        $module = $_POST["txtModule"];

        $sql1 = "SELECT * FROM lecturer_modules WHERE lecturer ='$lec' AND module_code = '$module';";
        $ret1 = mysqli_query($con,$sql1);

        if($row =mysqli_fetch_array($ret1)){
            echo " <center style='margin:10px'> <img src='http://localhost/FInal%20Project/dashboard/assets/images/error.png' alt='' width='25px' height='25px'> This lecturer already assign this module.</center>";
        }
        else{
            //sql command 
            $sql = "INSERT INTO lecturer_modules (lecturer, module_code) VALUES ('$lec','$module');";

            $ret = mysqli_query($con,$sql);

            if($ret == 1){
                echo " <center style='margin:10px'> <img src='http://localhost/FInal%20Project/dashboard/assets/images/successfull.png' alt='' width='25px' height='25px'> Module successfully assign for lecturer.</center>";
            }
        }
                ...
                <form action="#" method="post">
                    ...
                    <div id="input">
                            ...
                            <?php
                                ...
                                echo "<select name='txtLecturer' id='txtLecturer' required>";
