<?php
    ...
    if(isset($_POST["btnSubmit"])){
        ...
        if($row =mysqli_fetch_array($ret)){
            echo " <center style='margin:10px'> <img src='http://localhost/FInal%20Project/dashboard/assets/images/error.png' alt='' width='25px' height='25px'> This Course already has been added.</center>";
        }
        else{
            //sql command 
            $sql2 = "INSERT INTO course VALUES ('$code','$name',$duraction,'$faculty');";

            $ret2 = mysqli_query($con,$sql2);

            if($ret2 == 1){
                echo " <center style='margin:10px'> <img src='http://localhost/FInal%20Project/dashboard/assets/images/successfull.png' alt='' width='25px' height='25px'> Course successfully Added.</center>";
            }
        ...
        <div id="main">
            ...
            <section>
                ...
                <form action="#" method="post">
                    ...
                    <div id="input">
                        <input type="text" name="txtName" id="" placeholder="Enter Course Name" required><br>
                        <input type="text" name="txtCode" id="" placeholder="Enter Couser Code" required><br>
                        <input type="number" name="txtDuration" id="" placeholder="Enter Duration" required><br>
                    
                    
                        <select id="txtFaculty" name="txtFaculty" required>
                            <option value=''>--Select Faculty--</option> 
                            <option value="Computing">School of Computing</option>                                        
                            <option value="Business">School of Business</option>
                            <option value="Engineering">School  of Engineering</option>
                            <option value="Language">School of Language</option>
                        </select>
                    </div>
