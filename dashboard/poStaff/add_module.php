<?php
    ...
    if(isset($_POST["btnSubmit"])){
        ...
        //sql command 
        $sql = "SELECT * FROM modules WHERE module_code ='$Mcode'";
        $ret = mysqli_query($con,$sql);

        if($row =mysqli_fetch_array($ret)){
            echo " <center style='margin:10px'> <img src='http://localhost/FInal%20Project/dashboard/assets/images/error.png' alt='' width='25px' height='25px'> This Module already has been added. </center>";
        }
        else{
            //sql command 
            $sql2 = "INSERT INTO modules VALUES ('$Mcode',$hours,'$name','$course');";

            $ret2 = mysqli_query($con,$sql2);

            if($ret2 == 1){
                echo " <center style='margin:10px'> <img src='http://localhost/FInal%20Project/dashboard/assets/images/successfull.png' alt='' width='25px' height='25px'> Module successfully Added.</center>";
            }
                ...
                <form action="#" method="post">
                    ...
                    <div id="input">
                        ...
                        <?php
                            ...
                            echo "<select name='txtCourse' id='txtCourse' required>";
                        ...
                        <input type="text" name="txtName" id="txtName" placeholder="Enter Module Name" required><br>
                        <input type="text" name="txtMCode" id="txtMCode" placeholder="Enter Module Code" required><br>

                        <select name="txtHours" id="txtHours" required>
                            <option value=''>-- Select Module Hours --</option>
