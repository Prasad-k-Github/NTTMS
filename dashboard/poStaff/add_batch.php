<?php
    ...
    if(isset($_POST["btnSubmit"])){
        ...
        $Ccode = $_POST["txtCourse"];
        $Bcode = $_POST["txtBatch"];
        $cd = $_POST["txtCDirector"];

        //sql command 
        $sql = "SELECT * FROM batch WHERE batch_code ='$Bcode'";
        $ret = mysqli_query($con,$sql);

        if($row =mysqli_fetch_array($ret)){
            echo " <center style='margin:10px'> <img src='http://localhost/FInal%20Project/dashboard/assets/images/error.png' alt='' width='25px' height='25px'> This Batch already has been added.</center>";
        }
        else{
            //sql command 
            $sql2 = "INSERT INTO batch VALUES ('$Ccode','$Bcode','$cd');";

            $ret2 = mysqli_query($con,$sql2);

            if($ret2 == 1){
                echo " <center style='margin:10px'> <img src='http://localhost/FInal%20Project/dashboard/assets/images/successfull.png' alt='' width='25px' height='25px'> Batch successfully Added.</center>";
            }
            ...
            <section>
                <form action="#" method="post">
                    ...
                    <div id="input">
                        ...
                        <input type="text" name="txtBatch" id="" placeholder="Enter Batch Code" required><br>
                            ...
                            <?php
                                ...
                                echo "<select name='txtCDirector' id='txtCDirector' required>";
                                echo " <option value=''>--Select Course Director--</option>";
