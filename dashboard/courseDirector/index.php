...
<html lang="en">
            ...
            <section>
                <table id="tbl">
                    ...
                    <?php                      
                        ...
                        // Perform SQL 
                        $name = $_SESSION["name"]; // Store the session value in a variable
                        $sql = "SELECT * FROM asign_module  WHERE lecturer = '$name' AND date >= '$currentDate' ORDER BY date $order;";
    ...
    <script src="http://localhost/FInal%20Project/dashboard/assets/extensions/apexcharts/apexcharts.min.js"></script>
